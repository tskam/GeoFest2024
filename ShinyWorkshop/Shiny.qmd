---
title: "Building Web-enabled Geospatial Analytics Applications with Shiny"
subtitle: ""  
author: "[Dr. Kam Tin Seong](https://faculty.smu.edu.sg/profile/kam-tin-seong-486)<br/>Assoc. Professor of Information Systems"
...
-   Connecting to SMU visitor network
-   Downloading workshop data and sample shiny file by clicking on this [link](https://smu-my.sharepoint.com/:f:/g/personal/tskam_smu_edu_sg/ElRRsP3TXQlAskcS22M8fPoB1-TGLBYQrjfyao8R1SZH5A?e=pYMEaG). 
...
-   to integrate the analytical and visualisation packages of R (or python) without having to change from one programming language to another.
:::
...
::: callout-note
Visit [here](https://shiny.posit.co/r/layouts/) and read [Application layout guide](https://shiny.posit.co/r/articles/build/layout-guide/) to learn more about Shiny Layout
:::
...
There are at least three ways for deploying Shiny application.  They are:

- [Shinyapps.io](https://www.shinyapps.io/?_gl=1*1xig30l*_ga*MTg3Mzg2NTY2NS4xNzIxNzkxNDQz*_ga_8QJS108GF1*MTcyOTAzODkzOC4xMC4xLjE3MjkwNDEzOTQuMC4wLjA.*_ga_2C0WZ1JHG0*MTcyOTAzODkzMC4yNC4xLjE3MjkwNDEzOTUuMC4wLjA.)
...
A self-service platform that makes it easy for you to share your shiny applications on the web in just a few minutes. 

![](img/image35.jpg)

::: callout-note
Visit this [page](https://docs.posit.co/shinyapps.io/guide/) to learn more about Shinyapps.io
:::
...
::: callout-note
Read this [article](https://shiny.posit.co/r/articles/build/themes/) to learn more about Shiny theme
:::
...
-   [Shiny video series](https://www.youtube.com/playlist?list=PL9HYL-VRX0oRbLoj3FyL5zeASU5FMDgVe) on youtube
